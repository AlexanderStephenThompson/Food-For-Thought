...
01-bronze/data/train.json: marketing phrases (low sodium, fat free), prep
...
Lexicon data lives in 01-bronze/lexicons/modifier_strip.json and is loaded
...
def load_modifier_lexicon(path: str | Path) -> ModifierLexicon:
    ...
    Examples:
        >>> lexicon = load_modifier_lexicon("01-bronze/lexicons/modifier_strip.json")
