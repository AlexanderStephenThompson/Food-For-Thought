...
Condenses 01-bronze/reports/resolution_statistics.json and
...
def build_coverage_payload(
    ...
    Args:
        resolution_statistics: 01-bronze/reports/resolution_statistics.json payload with
            "train" and "test" splits.
        ingredients_payload: 02-silver/datasets/ingredients.json payload.
