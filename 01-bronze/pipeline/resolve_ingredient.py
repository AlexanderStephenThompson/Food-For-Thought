...
class IngredientResolver:
    ...
    Examples:
        ...
        ...     Path("02-silver/datasets/ingredients.json"), Path("01-bronze/lexicons"))
    ...
    def __init__(self, payload: dict, lexicons: PipelineLexicons) -> None:
        ...
        Args:
            payload: Parsed 02-silver/datasets/ingredients.json document (pinned
                schema version 1).
    ...
    def from_payload(
        ...
        Args:
            payload: Parsed 02-silver/datasets/ingredients.json document.
    ...
    def from_paths(
        ...
        Args:
            vocabulary_path: Path to 02-silver/datasets/ingredients.json.
