"""Tests for silver.pipeline.compile_alias_table — the silver ingredients compiler.
...
from silver.pipeline.load_bronze_recipes import Recipe, build_train_index
from silver.pipeline.merge_evidence import CuisineShare, MergeEvidence
