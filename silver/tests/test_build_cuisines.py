"""Tests for silver.pipeline.build_cuisines.

All taxonomy tests run on small in-test recipe payloads. Only the production
smoke test reads silver/lexicons/cuisine_families.json, and only ever read-only.
"""
...
PRODUCTION_FAMILIES_PATH = locations.LEXICONS_DIRECTORY / "cuisine_families.json"
