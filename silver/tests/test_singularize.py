"""Tests for silver.pipeline.singularize: token singularization and lookup keys.

The lexicon under test is silver/lexicons/singularize_exceptions.json, built from
