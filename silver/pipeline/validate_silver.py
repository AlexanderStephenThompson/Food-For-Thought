...
def validate_ingredients_payload(payload: dict) -> None:
    ...
    Args:
        payload: Parsed silver/datasets/ingredients.json content.
...
def validate_resolution_statistics(statistics: dict) -> None:
    ...
    Args:
        statistics: Parsed silver/reports/resolution_statistics.json content with
...
def validate_silver_artifacts(
    ...
    Args:
        ingredients_payload: Parsed silver/datasets/ingredients.json.
        train_payload: Parsed silver/datasets/recipes_train.json.
        test_payload: Parsed silver/datasets/recipes_test.json.
        statistics: Parsed silver/reports/resolution_statistics.json.
