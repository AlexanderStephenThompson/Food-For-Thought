...
Condenses silver/reports/resolution_statistics.json and
silver/datasets/ingredients.json
...
from silver.pipeline.artifact_io import write_artifact_json
...
def build_coverage_payload(
    ...
    Args:
        resolution_statistics: silver/reports/resolution_statistics.json payload with
            "train" and "test" splits.
        ingredients_payload: silver/datasets/ingredients.json payload.
