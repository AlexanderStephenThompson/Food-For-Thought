...
3. Candidate pair generation — alias-scope variant groups whose key is
   ...
   known reorder artifacts live in silver/lexicons/manual_aliases.json.
...
from silver.pipeline.cuisine_divergence import evaluate_merge_candidate
...
from silver.pipeline.merge_gate import (
    JSD_FLOOR_BITS,
    NULL_MULTIPLIER,
    GateAction,
    GateDecision,
...
from silver.pipeline.normalize_text import clean_ingredient_text
from silver.pipeline.resolve_brands import (
    BrandLexicon,
    load_brand_lexicon,
    resolve_brand_to_generic,
)
from silver.pipeline.singularize import (
