...
from silver.pipeline.build_vocabulary import PipelineLexicons, load_pipeline_lexicons
from silver.pipeline.normalize_text import DegenerateKeyError, clean_ingredient_text
from silver.pipeline.resolve_brands import resolve_brand_to_generic
from silver.pipeline.singularize import make_lookup_key
from silver.pipeline.strip_modifiers import strip_safe_modifiers
...
class IngredientResolver:
    ...
    Examples:
        ...
        ...     Path("silver/datasets/ingredients.json"), Path("silver/lexicons"))
    ...
    def __init__(self, payload: dict, lexicons: PipelineLexicons) -> None:
        ...
        Args:
            payload: Parsed silver/datasets/ingredients.json document (pinned
                schema version 1).
    ...
    def from_payload(
        ...
        Args:
            payload: Parsed silver/datasets/ingredients.json document.
    ...
    def from_paths(
        ...
        Args:
            vocabulary_path: Path to silver/datasets/ingredients.json.
