...
FIXTURE_LEXICON_PATH = (
    PROJECT_ROOT / "tests" / "fixtures" / "resolve_brands" / "brand_patterns.json"
)
PRODUCTION_LEXICON_PATH = PROJECT_ROOT / "lexicons" / "brand_patterns.json"
PRODUCTION_ALIASES_PATH = PROJECT_ROOT / "lexicons" / "manual_aliases.json"
